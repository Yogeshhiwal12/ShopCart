...
export default function ProductItem({ item }) {
  ...
  function handleSave(item) {
    let url = `https://my-json-server.typicode.com/Yogeshhiwal12/ecommercedata/products/${item.id}`;
  ...
  return (
    //   container
    <div className=" product-item d-flex container-sm bg-white px-1 py-5 mt-4 flex-column flex-lg-row gap-3">
      {/* left section  */}
      <ToastContainer />
      <div className="product-item__image d-flex container-sm gap-5">
        <img
          src={item.thumbnail}
          alt=""
          width={"200rem"}
      ...
      {/* footer section  */}
      <div className=" product-item_footer_button align-self-end d-flex align-items-center gap-4 flex-lg-grow-1 p-1">
        {item.edit ? (
          <button
            type="button"
