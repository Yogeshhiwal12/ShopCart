        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item" >
              <Link to="/" className="nav-link active " href="#" style={{fontFamily:"sans-serif",fontWeight:"bold"}}>
                Products
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/addproducts" className="nav-link active" style={{fontFamily:"sans-serif",fontWeight:"bold"}}>
                Add a product
              </Link>
            </li>
          </ul>
